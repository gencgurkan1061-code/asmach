...
function requestCode(){
 ...
 const request={version:1,product:'asmach-license-request',requestId:crypto.randomUUID(),deviceId,company:'Test Makina',contact:'test@example.com',note:'Çevrimdışı talep',appVersion:'2.0.4',createdAt:Math.floor(Date.now()/1000),proof};
